...
export class TontineBilanComponent implements OnInit{
  ...
  ngOnInit() {
    ...
    let tontineCall = this.tontineService.getTontineById(this.idTontine);
    ...
    forkJoin([cotsCall,nbCotsCall,nbRetardCall,nbPaidCall,nbNonPaidsCall,tontineCall]).subscribe(data=>{
